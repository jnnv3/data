...
## 4. 주 매출이면서 cart 전환율이 높았던 스마트폰과 전환율이 낮았던 카메라 유저 시간 비교

![alt text](pictures/image2.png)

주 매출 카테고리이면서 전환율이 높았던 smartphone과 cart 전환율이 낮았던 camera를 대상으로 view 이후 Cart까지 걸린 시간을 유저 기준으로 비교했습니다.
